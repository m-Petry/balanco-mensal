  ...
  return (
    <Card className="h-full flex flex-col">
      <Tabs value={activeTab} onValueChange={setActiveTab} defaultValue="list" className="flex flex-col flex-1">
        ...
        <TabsContent value="list" className="flex flex-col flex-1 pb-0 mt-0 px-2 sm:px-3 md:px-4">
        ...
        <TabsContent value="timeline" className="flex flex-col flex-1 pb-0 mt-0 px-2 sm:px-3 md:px-4">
          <TimelineChart 
